...
export function GamifiedMissionsDashboard() {
  ...
  return <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      {stats.map((stat, index) => <Card key={stat.label} className={`${stat.bgColor} border-2 hover:shadow-lg transition-all duration-300 animate-fade-in`} style={{
