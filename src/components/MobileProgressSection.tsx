...
export function MobileProgressSection() {
  ...
  return (
    <Button 
      variant="ghost" 
      className="h-6 bg-gradient-to-r from-blue-50 to-purple-50 hover:from-blue-100 hover:to-purple-100 border border-blue-200/50 rounded-md transition-all duration-300 shadow-sm hover:shadow-md group min-w-0 flex-shrink-0 text-left px-2 py-0.5 text-gray-500"
    >
      <div className="flex items-center gap-1 min-w-0">
        ...
        {/* Plano de Assinatura - sempre visível */}
        <div className="flex items-center gap-0.5 flex-shrink-0">
