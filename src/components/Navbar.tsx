      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 xl:px-8">
        <div className="flex justify-between items-center h-12 sm:h-16 lg:h-18">
          ...
          <div className="flex items-center flex-shrink-0">
            <Link to="/" className="flex items-center gap-1.5 sm:gap-3 py-1 sm:py-2 group transition-all duration-300 hover:scale-105">
              <div className="w-7 h-7 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-blue-500 via-blue-600 to-purple-600 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:rotate-3">
                <Stethoscope className="w-3.5 h-3.5 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-white" />
              </div>
              {/* Nome sempre visível, mas compacto no mobile */}
              <div className="flex flex-col">
                <span className="text-sm sm:text-lg lg:text-xl xl:text-2xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 bg-clip-text text-transparent leading-tight group-hover:animate-pulse">
                  RevalidaQuest
                </span>
