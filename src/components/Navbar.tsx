        ...
        <div className="flex justify-between items-center h-16 sm:h-16 lg:h-18">
          ...
          <div className="flex items-center flex-shrink-0">
            <Link to="/" className="flex items-center gap-2 sm:gap-3 py-2 group transition-all duration-300 hover:scale-105">
              ...
              {/* Nome sempre visível, mas responsivo - Mobile: text-lg, Desktop: text-4xl */}
              <div className="flex flex-col">
                <span className="text-lg lg:text-4xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 bg-clip-text text-transparent leading-tight group-hover:animate-pulse">
                  RevalidaQuest
                </span>
