  ...
  return (
    <CardHeader className="text-center pb-2 pt-8 relative z-10">
      ...
      <div className="relative mx-auto mb-6 hidden lg:block">
        ...
        <div className="absolute -top-1 -right-1 w-6 h-6 bg-gradient-to-r from-red-500 to-red-600 rounded-full flex items-center justify-center shadow-lg shadow-red-400/50 animate-pulse">
