...
export function SupremeChallengeContent({
  ...
  return <CardContent className="relative z-10 text-center p-6 sm:p-8 backdrop-blur-sm px-[24px] bg-slate-900">
      {/* Epic Reward */}
      ...
      <div className="flex flex-col items-center gap-6">
        {hasWonBefore ? <div className="text-center w-full">
              ...
              <div className="relative z-10">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-6 border-2 border-white/20">
                  ...
                  <div className="flex items-center justify-center gap-4 flex-wrap">
                    ...
                    <Button onClick={handleCopyCoupon} variant="outline" size="sm" className="border-2 border-yellow-400 hover:bg-yellow-400 transition-all duration-200 text-gray-950">
                      {copied ? <>
                ...
                {/* Botão de Checkout */}
                <Button onClick={handleClaimPrize} disabled={claiming} className="relative group bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 hover:from-purple-700 hover:via-pink-700 hover:to-red-700 text-white text-xl font-bold py-4 px-8 rounded-full shadow-2xl transform hover:scale-105 transition-all duration-300 overflow-hidden mb-4">
