...
export function SupremeChallengeHeader({
  ...
  return <CardHeader className="relative bg-black/80 backdrop-blur-xl p-6 sm:p-8 border border-yellow-500/30">
      <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/5 to-yellow-400/5"></div>
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="grid grid-cols-3 gap-4 sm:gap-8 text-center max-w-2xl mx-auto">
          <div className="bg-black/50 backdrop-blur-sm rounded-2xl p-3 sm:p-4 border border-yellow-500/50">
