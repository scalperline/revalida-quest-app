...
export const QUESTOES_REVALIDA_2014_58_63: Question[] = [
  {
    ...
    area: "Clínica Médica",
    enunciado:
      "Uma mulher com 65 anos de idade apresenta o seguinte histórico: antecedentes de obesidade, hipertensão arterial e angioplastia coronariana prévia, em uso prévio de diltiazem - 90 mg/dia, propranolol - 40 mg duas vezes ao dia, AAS - 100 mg/dia, dinitrato de isossorbida e sinvastatina - 20 mg/dia. A paciente, residente em uma cidade do interior, apresentou, há cerca de 24 horas, quadro de infarto agudo do miocárdio com supradesnivelamento de ST em parede inferior associado a infarto do ventrículo direito. Como não havia equipe de hemodinâmica disponível, foi administrada estreptoquinase, com melhora apenas parcial da dor. Após estabilização clínica a paciente foi encaminhada para Serviço de Emergência de hospital terciário. Na admissão a paciente estava eupneica, orientada, ainda com queixas de dor precordial com as mesmas características, mas de menor intensidade e intermitente. A pressão arterial era de 100 × 60 mmHg, frequência cardíaca = 78 bpm, frequência respiratória = 16 irpm. As auscultas cardíaca e pulmonar estavam normais. Enquanto eram realizados os exames complementares e repetido o ECG, a paciente subitamente apresentou quadro de choque (pressão arterial = 60 × 40 mmHg), com rebaixamento do nível de consciência, palidez cutâneo-mucosa e insuficiência respiratória. A saturação de O₂ caiu para 75% em ar ambiente e a frequência cardíaca aumentou para 136 bpm. A perfusão periférica encontrava-se muito prejudicada e as extremidades frias e sudoreicas. O ictus cardíaco estava hipodinâmico e a ausculta cardíaca revelava bulhas audíveis, com 3ª bulha e sopro holossistólico pancardíaco, mais audível em borda esternal esquerda. Havia turgência jugular a 45º. A ausculta pulmonar revelava estertores bolhosos até os ápices.\n\nAlém da intubação orotraqueal, as medidas terapêuticas recomendadas são",
    options: [
      { id: "A", text: "iniciar noradrenalina e dobutamina e encaminhar para angioplastia de emergência." },
      { id: "B", text: "iniciar nitroprussiato de sódio e dopamina e realizar pericardiocentese de emergência." },
  ...
  } as any,
  {
    ...
    area: "Clínica Médica",
    enunciado:
      'Um homem com 55 anos de idade procura Unidade Básica de Saúde (UBS) queixando-se que há três meses apresenta cor amarelada da pele e dos "olhos", com coceira e urina muito escura. Refere piora progressiva dos sintomas há cerca de 20 dias, sente cansaço progressivo, que associa a emagrecimento de 20 kg nos últimos seis meses. Eventualmente refere dor em mesogástrio e nas costas, que melhora com antiácidos e jejum. História pregressa do etilismo (destilados) há mais de 30 anos. Retorna à UBS após 45 dias da primeira consulta, trazendo ultrassonografia abdominal que evidencia dilatação de vias biliares intra e extra-hepáticas.\n\nA hipótese diagnóstica e a conduta correta são',
    options: [
      { id: "A", text: "hepatite alcoólica e realização de biópsia hepática transparietal." },
      { id: "B", text: "adenocarcinoma de pâncreas e realização de colangiorressonância magnética." },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "hidratação e oxigenioterapia." },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "sertralina por via oral." },
      { id: "B", text: "diazepam por via oral." },
  ...
  },
  {
    ...
    area: "Clínica Médica",
    enunciado:
      "Um homem com 34 anos de idade, sem antecedentes patológicos prévios, procurou ontem uma Unidade Básica de Saúde porque vem evoluindo nos últimos quatro meses com queixas de poliúria, polidipsia e perda ponderal de cerca de 7 kg nesse período. Há dois meses realizou exames complementares que evidenciaram glicemia de jejum de 348 mg/dL (Valor de referência = 75 - 99 mg/dL). Nega história de diabetes na família. Desde então, vem em uso de doses crescentes de metformina e glibenclamida, atualmente com 1.700 mg/dia e 10 mg/dia, respectivamente. As auscultas cardíaca e pulmonar são normais. Refere peristáltica dos sintomas e os exames complementares solicitados hoje revelaram: glicemia de jejum = 296 mg/dL, glicemia 2h após o café da manhã = 412 mg/dL, hemoglobina glicada 10,1% (Valor de referência: 3,8% - 6,4%). Ao exame o paciente mostra-se desidratado, corado, pressão arterial 110 × 75 mmHg, circunferência abdominal = 92 cm, índice de massa corporal - IMC = 23,3 kg/m², peso = 60 kg.\n\nAlém de referenciar para o especialista, a conduta adequada para esse paciente é",
    options: [
      { id: "A", text: "aumentar as doses de glibenclamida e de metformina, adicionar insulina NPH antes de dormir." },
      { id: "B", text: "manter as doses de glibenclamida e metformina, adicionar insulina NPH antes do café da manhã e antes do jantar." },
