...
export const QUESTOES_REVALIDA_2015_VERMELHA_1_26: Question[] = [
  {
    id: 1,
    year: 2015,
    ...
    options: [
      { id: "A", text: "constituem sintomas precoces de gravidez múltipla, de modo que a principal medida no momento é aguardar o resultado da ultrassonografia para verificar gemelaridade." },
      { id: "B", text: "são sinais de alerta para problemas como a neoplasia trofoblástica gestacional, sendo recomendada a utilização de antieméticos e monitorização dos níveis de gonadotrofina coriônica." },
  ...
  },
  {
    ...
    area: "Clínica Médica",
    enunciado:
      "Um paciente de 72 anos de idade, hipertenso e diabético, morador de casa de repouso, é trazido à Unidade de Pronto Atendimento (UPA) com queixa de dor abdominal aguda, de intensidade progressiva, há aproximadamente 3 horas. Ao exame encontra-se com fácies de dor, desidratado e pálido. Pressão arterial = 100 x 60 mmHg; FC= 122 bpm (arrítmico); FR = 20 ipm. O abdome encontra-se bastante distendido, doloroso à palpação superficial e profunda com ruídos hidroaéreos hipoativos. Refere constipação intestinal, herniorrafia inguinal esquerda há 30 anos e uso crônico de diurético tiazídico, amiodarona e metformina. Foi realizada reposição volêmica vigorosa e os exames séricos foram coletados. A radiografia simples de tórax com cúpulas diafragmáticas não mostra pneumoperitônio. A radiografia simples de abdome está ilustrada abaixo.\n\nResultados dos exames séricos:\nHb = 14,5 g/dL (normal = 12 a 14,5 g/dL);\nHt = 48% (normal = 36 a 42%);\nGlóbulos brancos = 11.000 mm³ com 8% de bastonetes e 86% de segmentados (normal = 4,8 entre 4 e 11.000 mm³ com menos de 10% de bastonetes);\nSódio = 135 mEq/L (normal entre 135 e 145 mEq/L);\nPotássio = 4,4 mEq/L (normal entre 3,5 e 4,5 mEq/L);\nLactato = 6 mg/dL (normal < 2 mg/dL);\nCreatinina = 1,5 mg/dL (normal entre 0,6 e 1,2 mg/dL); e\nUreia =98 mg/dL (normal entre 30 e 60 mg/dL).\n\nO diagnóstico mais provável é de",
    image: "/lovable-uploads/bf543fdf-4cff-449c-b2c7-cff3e0ef7c40.png",
    options: [
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "não preenche os critérios de Jones pela ausência de eritema marginado e de nódulos subcutâneos." },
      { id: "B", text: "não apresenta diagnóstico de febre reumática, pois não está presente a Coreia de Sydenham, que é um critério maior." },
  ...
  },
  {
    ...
    area: "Pediatria",
    enunciado:
      "Lactente masculino de três meses de idade é trazido pela mãe ao ambulatório de Pediatria. A mãe refere que há um mês a criança iniciou com coriza mucossanguinolenta e irritabilidade com choro fácil. Ao nascimento: peso = 2,2 kg; perímetro cefálico = 35 cm; comprimento = 48 cm. Ao exame físico verifica-se cor à mobilização do braço esquerdo com choro intenso, coriza mucossanguinolenta bilateral e erosão em lábio superior; palidez cutâneo-mucosa +/4+; fígado a 3,5cm do rebordo costal direito e 3,5cm do apêndice xifoide; baço a 4 cm do rebordo costal esquerdo.\n\nConsiderando a principal hipótese diagnóstica, quais são, respectivamente, o exame a ser solicitado e o resultado mais provável?",
    options: [
      { id: "A", text: "Tomografia computadorizada do crânio; velamento dos seios da face." },
      { id: "B", text: "Tomografia computadorizada do crânio; calcificações cranianas corticais." },
  ...
  },
  {
    ...
    area: "Clínica Médica",
    enunciado:
      "Uma paciente de 41 anos de idade, com queixa de dor epigástrica em queimação de longa data relacionada à ingestão de alimentos condimentados, retorna em consulta ambulatorial, tendo como resultado de endoscopia digestiva alta o diagnóstico de úlcera duodenal e pesquisa de H.pylori positivo. Relatava uso esporádico de antiácidos, mas com pouca melhora da dor. Nega uso de anti-inflamatórios não esteroidais (AINES).\n\nQual a associação de medicamentos com melhor nível de evidência científica para o tratamento desse caso?",
    options: [
      { id: "A", text: "Agente antissecretor, omeprazol e claritromicina." },
      { id: "B", text: "Inibidor da bomba de prótons, eritromicina e amoxicilina." },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "garantir que o horário diário de funcionamento das Unidades de Saúde da Família tenha o mesmo padrão em todos os territórios." },
      { id: "B", text: "dialogar com a comunidade acerca das características e organização do serviço, de modo a estabelecer sua efetiva implantação." },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Orientar sobre os riscos de encarceramento, obstrução e estrangulamento, e encaminhar para agendamento de cirurgia." },
      { id: "B", text: "Orientar sobre o tratamento conservador e sugerir medidas paliativas considerando o risco de recidiva pós-cirúrgica." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "Polipose retossigmoide." },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "redução de consumo de alimentos tradicionais da dieta brasileira (arroz e feijão), associada a aumento do consumo de alimentos ultraprocessados." },
      { id: "B", text: "aumento dos coeficientes de fecundidade associado à redução do coeficiente de mortalidade, com consequente aumento da expectativa de vida." },
  ...
  },
  {
    ...
    area: "Pediatria",
    enunciado:
      "Um recém-nascido (RN) com 10 dias de vida, do sexo masculino, é levado ao Posto de Saúde para avaliação, uma vez que seu pai acabou de receber o diagnóstico de tuberculose pulmonar. A mãe não aleita, tendo iniciado aleitamento misto com fórmula, não possui queixa específica em relação à criança. A gestação e o parto não apresentaram intercorrências e o aleitamento materno segue sem dificuldades. O RN mostra-se em bom estado geral, ativo, corado, hidratado, e o restante do exame físico é normal. Nessa situação, qual das condutas seguintes é a mais adequada?",
    options: [
      { id: "A", text: "Não vacinar o RN com a BCG, iniciar isoniazida e mantê-la por 3 meses. Após esse período o recém-nascido deverá realizar PPD e se o resultado for maior que 5 mm, manter a medicação por mais 3 meses. Se for menor que 5 mm, suspender a medicação e vacinar com BCG." },
      { id: "B", text: "Não vacinar o RN com a BCG, iniciar isoniazida, rifampicina, pirazinamida e etambutol, e mantê-los por 3 meses. Após esse período, realizar PPD. Se o resultado for menor que 5 mm, suspendê-las e vacinar com BCG." },
  ...
  },
  {
    ...
    area: "Ginecologia e Obstetrícia",
    enunciado:
      "Uma gestante de 26 anos de idade, primigesta, comparece à Unidade Básica de Saúde no dia 25 de junho de 2015, relatando que seu bebê passou da data de nascer. Ao verificar o cartão da gestante, o médico encontrou anotação de data da última menstruação em 06/09/2014 e realização de ultrassonografia em 12/11/2014 mostrando idade gestacional de 08 semanas e 04 dias. Ao exame obstétrico: altura uterina = 34 cm, feto único, cefálico, insinuado, frequência cardíaca fetal = 140 bpm sem desacelerações, colo apagado 50%, fechado e pressão arterial = 100 x 60 mmHg.\n\nApós essa avaliação, qual seria a conduta apropriada?",
    options: [
      { id: "A", text: "Tranquilizar a gestante e, de comum acordo com ela, encaminhá-la a uma maternidade para provável indução do parto." },
      { id: "B", text: "Encaminhar a gestante para a maternidade para realização de cesárea segmentar, pois se trata de uma gravidez com mais de 41 semanas." },
  ...
  },
  {
    ...
    area: "Clínica Médica",
    enunciado:
      "Uma mulher de 75 anos de idade procurou atendimento em uma Unidade Básica de Saúde por apresentar, há três dias, quadro de febre baixa, tosse com escarro purulento e leve dispneia. Fumante há cerca de 35 anos (cerca de 25 cigarros/dia), possui diagnóstico prévio de Doença Pulmonar Obstrutiva Crônica. Há 10 dias, apresenta, ainda, quadro com coriza, diarreia, tosse seca e mialgia. Ao exame físico, observa-se: mucosas descoradas (++/+4), taquipneia, temperatura axilar = 38ºC, frequência respiratória = 32 irpm, frequência cardíaca = 120 bpm. A ausculta pulmonar permitiu constatar frêmito tóraco-vocal aumentado e estertores crepitantes no terço inferior do hemitórax esquerdo. A radiografia de tórax evidenciou condensação em lobo inferior esquerdo, sem derrame pleural.\n\nConsiderando o quadro apresentado, quais são, respectivamente, o principal agente infeccioso no quadro clínico descrito e a conduta apropriada a ser tomada nesse momento para a paciente?",
    options: [
      { id: "A", text: "Streptococcus pneumoniae; encaminhamento para internação hospitalar e início de antibioticoterapia venosa." },
      { id: "B", text: "Staphylococcus aureus; prescrição de antibioticoterapia empírica e acompanhamento ambulatorial." },
  ...
  },
  {
    ...
    area: "Clínica Médica",
    enunciado:
      "Uma senhora de 85 anos de idade, tem visita domiciliar da Equipe de Saúde da Família (ESF) solicitada por sua cuidadora, pois há dois dias tem apresentado comportamento estranho. Fala coisas desconexas, teve alucinações visuais e compõe-se de forma agressiva algumas vezes. A paciente faz seguimento regular com a ESF há 10 anos, atualmente com assistência domiciliar por está restrita ao leito há quase um ano devido a quadro contínuo. A médica da equipe conhece a paciente e sabe que ela nunca teve problemas cardiovasculares, cognitivos ou de comportamento e que não faz uso de medicamentos contínuos. No exame físico, mostra-se desorientada em relação ao tempo.\n\nA hipótese diagnóstica mais provável e a conduta adequada, são, respectivamente,",
    options: [
      { id: "A", text: "quadro depressivo; tratamento medicamentoso com tricíclico e avaliação por psicólogo." },
      { id: "B", text: "quadro infeccioso agudo; solicitação de raio X, exame de urina e hemograma para melhor avaliação." },
  ...
  },
  {
    ...
    area: "Ginecologia e Obstetrícia",
    enunciado:
      "Uma parturiente de 34 anos de idade, grande multípara (VI Gestas), apresentou diabetes gestacional e está com gestação de 39 semanas. Deu entrada na Maternidade em trabalho de parto, com feto único, vivo e em apresentação cefálica. Evoluiu para parto vaginal após duas horas de período expulsivo, para concepto do sexo masculino com 4.100 kg, apgar 8/9. Logo após a dequitação da placenta, o sangramento uterino se acentuou. Exame obstétrico: útero de consistência amolecida, palpável acima da cicatriz umbilical; ausência de restos placentários, ausência de lacerações do canal de parto. A paciente evolui rapidamente com hipotensão, taquicardia e alteração da consciência.\n\nEssa situação poderia ter sido evitada se",
    options: [
      { id: "A", text: "a paciente tivesse sido submetida a um parto cesárea." },
      { id: "B", text: "houvesse a prescrição de ocitocina via intravenosa no parto." },
  ...
  },
  {
    ...
    area: "Medicina Preventiva",
    enunciado:
      "Uma famosa modelo profissional de 22 anos, acompanhada de sua mãe, procura um cirurgião plástico para a realização de um novo procedimento estético que ele inventou e tem sido extensa divulgação na mídia. Após a cirurgia, o resultado não agradou e a paciente decidiu processar o médico pelo mau resultado, questionando a técnica utilizada bem como o fato de ter havido divulgação de suas fotos durante sua internação pelos funcionários da clínica. Na sua defesa, o cirurgião alegou que a paciente foi orientada pela clínica e que assinou o termo de consentimento, tendo sido prestado por ele toda a assistência necessária.\n\nTendo como base o Código de Ética Médica, no presente caso,",
    options: [
      { id: "A", text: "o termo de consentimento esclarece os riscos e a paciente torna-se responsável pelas eventuais intercorrências, independentemente da ação do médico." },
      { id: "B", text: "o médico não pode se responsabilizar pelas ações de seus funcionários na exposição de fotos da paciente durante a internação." },
  ...
  },
  {
    ...
    area: "Pediatria",
    enunciado:
      "Uma lactente de 8 meses de idade nascida prematuramente com 34 semanas de gestação, é atendida no Pronto-socorro com história de tosse há três dias. A mãe relata que, hoje, a criança está mais pálida, sonolenta e com dificuldades para respirar, a ponto de impedir a ingestão de alimentos. Ao exame físico, a lactente apresenta-se irritada, em regular estado geral, cianótica, afebril, com sibilância e frequência respiratória aumentada para a idade, com tiragem intercostal e subcostal. A radiografia de tórax na posição anteroposterior está reproduzida a seguir.",
    image: "/lovable-uploads/c427aaad-489d-4ebe-890a-3a42cc91ed9a.png",
    options: [
      { id: "A", text: "Determinar internação para iniciar oxigenioterapia devido aos sinais de gravidade." },
      { id: "B", text: "Determinar internação para início imediato de antibioticoterapia de amplo espectro." },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Agendamento de colecistectomia nessa mesma internação pelo risco de recorrência da pancreatite." },
      { id: "B", text: "Colecistectomia em um período de até três meses para permitir que o processo inflamatório regrida completamente." },
  ...
  },
  {
    ...
    area: "Clínica Médica",
    enunciado:
      "Uma mulher de 18 anos de idade, parda, foi avaliada em um ambulatório de atenção especializada por apresentar fraqueza, cansaço e episódios de dores musculares e articulares, principalmente em mãos e pés. Ela relata apresentar o primeiro destes episódios, com crises frequentes de dor de início súbito. Ao exame físico, apresentava-se com mucosas hipocoradas e escleróticas ictéricas, além de edema de articulações de mãos e pés. Os sinais vitais aferidos mostraram pressão arterial = 90 × 50 mmHg; frequência cardíaca = 108 bpm; frequência respiratória = 18 irpm e temperatura axilar = 37,1ºC.\n\nOs exames laboratoriais iniciais revelaram:\nHemoglobina = 8,3 g/dL (VR = 11,5 - 15 g/dL);\nHematócrito = 25,2% (VR = 35 - 45%);\nVCM = 90 fL (VR = 80 - 96 fL);\nLeucócitos = 7.500/mm³; com contagem diferencial normal;\nPlaquetas = 197.000/mm³ (VR = 100.000 - 400.000 mm³);\nReticulócitos = 7,4% (VR = 0,5 - 1,5%);\nDesidrogenase láctica = 870 U/L (VR = 240 - 480 U/L);\nAspartato aminotransferase = 52 U/L (VR = até 38 U/L).\n\nCom base no quadro descrito, qual exame complementar deverá ser realizado a fim de se obter o provável diagnóstico etiológico?",
    options: [
      { id: "A", text: "Teste de Coombs direto." },
      { id: "B", text: "Hematoscopia de sangue periférico." },
