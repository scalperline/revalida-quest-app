...
export const QUESTOES_REVALIDA_2017_PROVA1_91_100: Question[] = [
  {
    ...
    enunciado:
      "Uma mulher com 20 anos de idade, primigesta na 19ª semana de gestação, procura o Pronto-Socorro com história de febre não medida há 24 horas e queixa de disúria, polaciúria, urgência miccional e dor lombar à direita. Ao exame físico, apresenta-se em regular estado geral, afebril, frequência cardíaca = 98 bpm, frequência respiratória = 20 irpm, pressão arterial = 90 x 60 mmHg, desidratada ++/4+ e com dor à puno-percussão da região lombar direita.\n\nDiante desse quadro clínico, a conduta adequada é",
    options: [
      {
        id: "A",
        text: "internação hospitalar para hidratação e administração de analgésicos, antiespasmódicos e antieméticos endovenosos; solicitação de urocultura e antibiograma para início de antibioticoterapia.",
      },
      {
        id: "B",
        text: "acompanhamento na Unidade de Atenção Básica; solicitação de urocultura e antibiograma para início de antibioticoterapia por via oral.",
      },
      {
        id: "C",
        text: "acompanhamento na Unidade de Atenção Básica; início de tratamento sintomático e antibioticoterapia por via oral.",
      },
      {
        id: "D",
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "B",
        text: "Prostatectomia radical, seguida de quimioterapia adjuvante.",
      },
      {
        id: "C",
        text: "Cirurgia minimamente invasiva, com ressecção transuretral da próstata.",
      },
      {
        id: "D",
  ...
  },
  {
    ...
    options: [
      {
        id: "A",
        text: "informar que o resultado do exame é provavelmente benigno e que o acompanhamento pode continuar a ser feito no serviço de atenção primária, com repetição da mamografia em 6 meses.",
      },
      {
        id: "B",
        text: "informar que o resultado do exame é normal e que o atendimento pode continuar a ser feito no serviço de atenção primária, com avaliação clínica anual e repetição da mamografia em 2 anos.",
      },
      {
        id: "C",
        text: "informar que o resultado do exame é inconclusivo e solicitar a realização de ultrassonografia mamária complementar, mantendo o acompanhamento no serviço de atenção secundária.",
      },
      {
        id: "D",
  ...
  },
  {
    ...
    area: "medicina de família e comunidade / saúde coletiva",
    enunciado:
      "Uma adolescente com 16 anos de idade é trazida à Unidade Básica de Saúde (UBS) pela mãe, apresentando quadro de tristeza e amenorreia há 4 meses. A mãe relata que o comportamento da adolescente tem mudado desde que ela passou a frequentar o grupo de dança da comunidade onde mora, há um ano. Informa que, desde então, a filha vem perdendo peso e tem se alimentado apenas com frutas e verduras. Recusa-se a participar dos eventos familiares e se isolando de amigos da escola, embora continue a frequentar com assiduidade o grupo de dança.\n\nAo exame físico, a adolescente mostra-se triste e pouco interativa, está hipocorada, hidratada, eupneica. Apresenta índice de massa corporal = 15 kg/m²; pressão arterial = 90 x 50 mmHg; frequência cardíaca = 56 bpm. Observa-se discreto aumento de volume das parótidas bilateralmente. Exames laboratoriais realizados na UBS mostram anemia normocrômica/normocítica, elevação de aminotransferases, hiponatremia, normocalemia e nível de creatinina normal.\n\nDiante do quadro clínico apresentado, o diagnóstico e a conduta mais apropriada a ser tomada pelo médico de família são",
    options: [
      {
        id: "A",
        text: "quadro de depressão na adolescência, de grau grave; encaminhar a paciente para internação psiquiátrica e orientar a família acerca do risco de suicídio e comprometimento do desenvolvimento psicomotor.",
      },
      {
        id: "B",
        text: "quadro provável de depressão na adolescência, de grau leve a moderado; prescrever inibidor da recaptura da serotonina na UBS e orientar a família a respeito dos aspectos normais da adolescência.",
      },
      {
        id: "C",
        text: "quadro provável de transtorno alimentar moderado; solicitar a realização de recordatório alimentar, com acompanhamento na UBS, e orientar a família a respeito da alimentação saudável na adolescência.",
      },
      {
        id: "D",
  ...
  },
  {
    ...
    options: [
      {
        id: "A",
        text: "desenvolvimento normal, com comportamentos comuns na infância; orientar a família.",
      },
      {
        id: "B",
        text: "transtorno de déficit de atenção/hiperatividade; iniciar tratamento com risperidona.",
      },
      {
        id: "C",
        text: "transtorno do espectro autista; encaminhar o paciente para atendimento especializado.",
      },
      {
        id: "D",
