  ...
  return (
    <ResponsiveLayout>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 dark:from-gray-900 dark:to-gray-800 relative">
        ...
        <main className="relative z-10 responsive-container responsive-padding pb-8">
          {/* Enhanced Hero Section */}
          <div className="text-center mb-8 lg:mb-12 relative pt-6 sm:pt-8">
            ...
            <div className="relative z-10 p-6 lg:p-8">
              <h1 className="responsive-text-heading text-gray-900 mb-4 lg:mb-6 leading-tight">
                Bem-vindo ao{" "}
                ...
                <span className="inline-block animate-bounce ml-2 text-lg sm:text-2xl">👋</span>
              </h1>
              
              <p className="responsive-text-body text-gray-600 max-w-4xl mx-auto leading-relaxed">
              ...
              {/* Motivational Badge */}
              <div className="mt-6 inline-flex items-center gap-2 bg-gradient-to-r from-green-100 to-emerald-100 border-2 border-green-200 rounded-full px-4 py-2 shadow-lg animate-fade-in">
          ...
          <div className="responsive-grid-cards mb-8 lg:mb-12">
            <div className="glass-effect rounded-2xl responsive-padding shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 group">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full shadow-lg group-hover:animate-pulse">
                  <BookOpen className="w-5 h-5 lg:w-6 lg:h-6 text-white" />
                </div>
                <div>
                  <p className="text-2xl lg:text-3xl font-bold text-gray-900">1.500+</p>
                  <p className="text-sm lg:text-base text-gray-600">Questões Oficiais</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-effect rounded-2xl responsive-padding shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 group">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-3 bg-gradient-to-r from-green-500 to-green-600 rounded-full shadow-lg group-hover:animate-pulse">
                  <Target className="w-5 h-5 lg:w-6 lg:h-6 text-white" />
                </div>
                <div>
                  <p className="text-2xl lg:text-3xl font-bold text-gray-900">10+</p>
                  <p className="text-sm lg:text-base text-gray-600">Missões Ativas</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-effect rounded-2xl responsive-padding shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 group">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-3 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full shadow-lg group-hover:animate-pulse">
                  <TrendingUp className="w-5 h-5 lg:w-6 lg:h-6 text-white" />
                </div>
                <div>
                  <p className="text-2xl lg:text-3xl font-bold text-gray-900">15</p>
                  <p className="text-sm lg:text-base text-gray-600">Anos de Provas</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-effect rounded-2xl responsive-padding shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 group">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-3 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full shadow-lg group-hover:animate-pulse">
                  <Stethoscope className="w-5 h-5 lg:w-6 lg:h-6 text-white" />
                </div>
                <div>
                  <p className="text-2xl lg:text-3xl font-bold text-gray-900">11.2k+</p>
                  <p className="text-sm lg:text-base text-gray-600">Médicos Ativos</p>
                </div>
              </div>
            </div>
          </div>
